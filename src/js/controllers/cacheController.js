    ...
    */
    ...
    if (!!sessionStorage.getItem('categories')) {
        ...
        var paramCategories = {
            ...
            sort: 'ASC',
            // limit: 1000,
            fields: ['id', 'active', 'color', 'name', 'slug'].join()
        };
        rest().get({
            type: $scope.type,
            params: $httpParamSerializer(paramCategories)
    ...
    if (!!sessionStorage.getItem('filetypes')) {
        ...
        var paramFiletypes = {
            orderBy: 'name',
            limit: 1000,
            fields: ['id', 'api', 'mimetype', 'name', 'slug'].join()
        };

        rest().get({
            type: 'filetypes',
            // params: 'orderBy=name&limit=1000&fields=id,api,mimetype,name,slug'
            params: $httpParamSerializer(paramFiletypes)
        }, function (filetypes) {
    ...
    if (!!sessionStorage.getItem('tags')) {
        ...
        rest().get({
            type: 'tags',
            params: $httpParamSerializer(paramTags)
    ...
    if (!!sessionStorage.getItem('organizations')) {
        ...
        rest().get({
            type: 'organizations',
            params: $httpParamSerializer(paramOrganizations)
